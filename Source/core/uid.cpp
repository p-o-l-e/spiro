...
namespace core
{
     ...
     * ***********************************************************************************************************************/
     ...
     const uint32_t uid_t::encode_uid(const map::module::type& mt, const map::parameter::type& pt, const int& mp, const int& pp) noexcept
     {
    ...
    const uid_t uid_t::decode_uid(const uint32_t& data) noexcept
    {
        ...
        (
            ...
            static_cast<map::parameter::type>(extract_byte(data, p_index)),
     ...
     uid_t::uid_t(const uint32_t& data):
         ...
         parameter(static_cast<map::parameter::type>(extract_byte(data, p_index))),
         parameter_position(extract_byte(data, p_position))
     {};
  
     uid_t::uid_t(const map::module::type& mt, const map::parameter::type& pt, const int& mp, const int& pp):
